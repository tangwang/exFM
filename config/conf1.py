...
varlen_sparse_str_feat_list =['book_prefer', 'cate1_prefer', 'cate2_prefer', 'tag_prefer', 'uid_with_profiles', 'tid', 'ttype', 'bid', 'name', 'author', 'category1', 'category2', 'tags', 'freshness', 'stats', 'tenant_stats', 'type_stats', 'recall', 'tid_bid', 'tid_category1', 'tid_category2', 'tid_tags', 'ttype_bid', 'ttype_category1', 'ttype_category2', 'ttype_tags'] # 字符串类型序列特征
