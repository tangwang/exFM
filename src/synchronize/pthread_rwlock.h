...
class PthreadRWLock {
 ...
 public:
  ...
  inline void rdlock() { pthread_rwlock_rdlock(&lock_); }

  inline int tryRdlock() { return pthread_rwlock_tryrdlock(&lock_); }

  inline void wrlock() { pthread_rwlock_wrlock(&lock_); }
